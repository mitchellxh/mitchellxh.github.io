...
const THREADS = [
  ...
  },
  {
    ...
    tier: 0.82,
    desc: 'A 3D-segmentation CNN (88% sensitivity, 1,000+ scans) becomes retrieval-augmented generation over 1,000+ papers. Computer vision → LLMs.',
  },
  {
    id: 'gpu',
    label: 'GPU / CUDA',
    tier: 0.62,
    desc: 'GPU-trained CNNs → migrating 25+ research workflows to GPU (10–40× faster) → building the CDS cluster explorers.',
  },
  {
    id: 'imaging',
    label: 'Imaging data',
...
const NODES = [
  ...
  { id: 'rcs', year: 2022, type: 'role', era: 'hpc', short: 'BU · RCS', title: 'Research Computing App & Data Specialist III', org: 'Boston University · 2022–2024', detail: 'HPC modernization: containerization (Docker / Singularity) for 200+ researchers; a 100+ package software stack via Lmod / EasyBuild / Spack; parallelized scientific code across multi-core systems (MPI / OpenMP / CUDA); 60% average compute-time cut.', threads: ['teaching'], row: 0 },
